...
//             {/* Count */}
//             <h2
//               className="text-1xl sm:text-4xl lg:text-5xl font-bold"
...
const HomeStats = () => {
  ...
  return (
    <section className="bg-[#eef3f7] py-14 overflow-hidden">
      {/* Heading */}
      <h2 className="text-center text-3xl md:text-4xl font-bold text-[#0f4c81] mb-12">
        Impact Factor
      </h2>
      ...
      >
        {stats.map((item, index) => (
          ...
          >
            ...
            {/* Label */}
            <p className="mt-3 text-sm md:text-base text-gray-600 leading-snug">
              {item.label}
            </p>
          </motion.div>
        ))}
