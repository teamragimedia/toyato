...
import CarbonMeasurement from "../../assets/Carbonmeasurement.gif";
import Emission from "../../assets/emission.gif";
import Live from "../../assets/livedashboards.gif";
import Visualization from "../../assets/visualization.gif";
import Benchmarking from "../../assets/benchmarking.gif";

export default function CarbonIntelligence() {
  const items = [
    {
      icon: CarbonMeasurement,
